namespace Battleship
{
    public class SuperCoolAgent : BattleshipAgent
    {
        ...
        public override BattleshipFleet PositionFleet()
        {
            ...
            myFleet.Carrier = new ShipPosition(5, 9, ShipRotation.Horizontal);
            myFleet.Battleship = new ShipPosition(0, 5, ShipRotation.Horizontal);
            myFleet.Destroyer = new ShipPosition(9, 0, ShipRotation.Vertical);
            myFleet.Submarine = new ShipPosition(2, 8, ShipRotation.Horizontal);
            myFleet.PatrolBoat = new ShipPosition(6, 6, ShipRotation.Horizontal);
